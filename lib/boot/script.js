...
document.querySelectorAll(
  ...
  // These document-led sections prioritize immediate readability. Their
  // section/media motion remains active, but their headings never blur or
  // wait for a per-word animation before becoming legible.
  if (el.closest(CLEAR_TEXT_SECTIONS)) return;
